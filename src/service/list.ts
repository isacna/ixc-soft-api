...
import { BodyRaw, IxcListResponse } from "../@types/types";


export async function listAll(url: string, token: string, table: string, body: BodyRaw): Promise<IxcListResponse> {
