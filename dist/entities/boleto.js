import { action, defineEntity, op } from "../core/entity.js";
    ...
    ops: {
        list: op({
            ...
            toBody: (v) => {
                ...
                if (v.idCliente)
                    filters.push({ field: "fn_areceber.id_cliente", value: v.idCliente });
                if (v.idContrato)
                    filters.push({ field: "fn_areceber.id_contrato", value: v.idContrato });
                const body = {
