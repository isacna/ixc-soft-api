    ...
    ops: {
        list: op({
            ...
            toBody: (v) => {
                const filters = [];
                if (v.idCliente)
                    filters.push({ field: "radusuarios.id_cliente", value: v.idCliente });
                if (v.idContrato)
                    filters.push({ field: "radusuarios.id_contrato", value: v.idContrato });
                if (v.online)
                    filters.push({ field: "radusuarios.online", value: v.online });
                if (v.ativo)
                    filters.push({ field: "radusuarios.ativo", value: v.ativo });
